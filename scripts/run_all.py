"""Полный повтор расчётов главы 7 (три примера) и сверка с результатами, по которым написан текст диссертации.
...
def main() -> int:
    ...
    ap.add_argument("--threads", type=int, default=1,
                    help="потоков PyTorch/OpenMP на процесс (по умолчанию 1, как при исходном расчёте: так числа ГНС "
                         "совпадают с диссертацией побитово; при 2 потоках они расходятся в 3–4-м знаке, а два параллельных "
